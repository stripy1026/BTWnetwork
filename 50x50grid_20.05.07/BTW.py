...
plt.title('Degree Distribution of 2D 50x50 lattice BTW model')
plt.xlabel('Degree k')
plt.ylabel('P(k)')
plt.xscale('log')
plt.yscale('log')
...
def ASDplot( ls, probran ):
    ...
    plt.title('Avalanche size Distribution of 2D 50x50 lattice BTW model')
...
nx.set_node_attributes(G, SB50, 'sand')
#print( 'initial state =' )
#showkey( SB5 )

plt.figure()
#SB50a = SB50.copy()
#simulate2( SB50a, t=100000 )
SB50b = SB50.copy()
simulate( SB50b, t=100000, probran=0.0026418437251063704 )
SB50c = SB50.copy()
simulate( SB50c, t=100000, probran=0.0015 )
SB50d = SB50.copy()
simulate( SB50d, t=100000, probran=0.004 )
plt.legend()
plt.show()
